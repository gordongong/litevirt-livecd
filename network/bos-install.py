...
class BosInstaller(object):
    ...
    def prepare_partitions(self):
        ...
        runcmd('parted -s %s mkpart primary ext2 1M 5000M' % self.drive)
    ...
    def install_bootloader(self):
        ...
        syscmds = (
                    ...
                    "cp -rf /dev/.initramfs/live/isolinux/* %s" % self.bootdir,
                    "cp -a %s %s" % (extlinux_template, extlinux_conf),
                    "sed -i 's/UUID=/UUID=%s/' %s" % (uuid, extlinux_conf),
